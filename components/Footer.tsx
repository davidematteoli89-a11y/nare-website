...
/**
 * Footer (Step 1H). Nessun logo RAI. Nessun link social inventato: la
      ...
      <Container className="grid grid-cols-1 gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm text-[var(--color-foreground-muted)]">
            Guida pratica e prudente all&apos;autoproduzione quotidiana, con Cristina di Narè.
          </p>
        </div>
      ...
      <div className="border-t border-[var(--color-border)] py-6">
        <Container>
          <p className="text-xs text-[var(--color-foreground-muted)]">
            © {new Date().getFullYear()} MeLoProduco — Cristina di Narè.
          </p>
        </Container>
      </div>
    </footer>
